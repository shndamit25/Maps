require([
  ...
  var isBrowserEligible = this.checkIfBrowserEligible()

  function checkIfBrowserEligible() {
    var browserInfo = getBrowserInfo();
    console.log(browserInfo)
    console.log('111111111111111111111111111111111111111', isNaN(browserInfo.version))
    if (browserInfo.browser == "Opera") {

    } else if (browserInfo.browser == "Microsoft Internet Explorer") {

    }
    if (browserInfo.browser == "Chrome" && browserInfo.version < 50) {
      document.getElementById('BrowserInfo').innerHTML = "Please update chrome version to atleast 50."
      return false;
    }
